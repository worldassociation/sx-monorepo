...
<template>
  ...
  <div class="s-box mb-4">
    <UiSelectorNetwork v-model="snapshotChainId" :definition="{
      type: 'number',
      title: 'Network',
      tooltip:
  ...
  <UiContainerSettings :title="`Select up to ${strategiesLimit} strategies`" description="(Voting power is cumulative)">
    <UiMessage v-if="!isTicketValid" type="danger"
      learn-more-link="https://snapshot.mirror.xyz/-uSylOUP82hGAyWUlVn4lCg9ESzKX9QCvsUgvv-ng84" class="mb-3">
    ...
    <UiStrategiesConfiguratorOffchain v-model:model-value="strategies" :network-id="networkId"
      :default-chain-id="snapshotChainId" :limit="strategiesLimit" />
  </UiContainerSettings>
</template>
