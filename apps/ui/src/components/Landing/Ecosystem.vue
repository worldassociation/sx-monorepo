<template>
  <div id="ecosystem" class="py-9 border-b relative overflow-hidden">
    ...
    <div class="absolute bottom-[-170px] md:top-6 left-[50%] -z-10 w-[506px] overflow-hidden text-center">
      <img src="@/assets/integrations.png" alt="Ecosystem" class="w-[506px] inline-block" />
    </div>
  </div>
</template>
