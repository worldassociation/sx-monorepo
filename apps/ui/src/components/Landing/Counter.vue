<template>
  <div id="counter" class="pt-8 border-b">
    <UiContainer class="!max-w-screen-lg">
      <div class="pb-6 max-w-[600px]">
        <h1 class="mb-4 font-display !text-[36px] sm:!text-[44px]">
          Enhancing a voting platform trusted by millions
        </h1>
      </div>
    </UiContainer>
  </div>
  <div class="border-b">
    <UiContainer class="!max-w-screen-lg !px-0">
      <div class="grid grid-cols-2 sm:grid-cols-4 text-md">
        ...
        <div class="border-r p-4 space-y-2">
          <h3 class="font-heading !text-[36px]">31m</h3>
          <div class="eyebrow">Votes</div>
        </div>
        <div class="p-4 space-y-2">
          <h3 class="font-heading !text-[36px]">3.6m</h3>
