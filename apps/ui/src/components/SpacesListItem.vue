...
<template>
  <AppLink :to="{ name: 'space-overview', params: { space: compositeSpaceId } }"
    ...
    <div class="relative inline-block mx-4 mt-[34px]">
      <UiBadgeNetwork :id="space.network" :size="!offchainNetworks.includes(space.network) ? 16 : 0" class="mb-2">
