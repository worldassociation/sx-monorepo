  ...
  <div>
    <div class="border-b mx-4 py-[14px] flex">
      <div class="flex-auto mr-4 w-0">
        <div class="space-x-2 flex">
          <div class="md:flex md:min-w-0 my-1 items-center leading-6">
            <AppLink :to="{
              ...
              <IC-pin v-if="topic.pinned" class="inline-block shrink-0 md:mt-1.5 size-[14px]" />
              <IS-lock-closed v-if="topic.closed" class="inline-block shrink-0 size-[16px] -mt-1 md:mt-1" />
        ...
        <div class="inline">
          <span class="mr-2.5">
            <img v-for="(user, i) in topic.users" :key="i" :src="user.avatar_template"
